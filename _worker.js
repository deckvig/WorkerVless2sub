...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/deckvig/WorkerVless2sub/main/addressesapi.txt', //可参考内容格式 自行搭建。
...
let addressesnotlsapi = [
	'https://raw.githubusercontent.com/deckvig/CFcdnVmess2sub/main/addressesapi.txt', //可参考内容格式 自行搭建。
];

let DLS = 8;//速度下限
let addressescsv = [
	'https://raw.githubusercontent.com/deckvig/WorkerVless2sub/main/addressescsv.csv', //iptest测速结果文件。
];
